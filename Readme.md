...
#### Datu pertsonalak
- **Izena:** Eman Turrientes Mendizabal  
- **Jaioteguna:** 2002  
- **Jaioterria:** Beasain (Gipuzkoa)  
...
| Posizioa           | Erdilaria                        |
| Harrobia           | Zubieta                          |
| Egoera             | Futbolari profesionala           |

### Lorpenak eta oharrak
- Jokalari gaztea eta etorkizun handikoa  
- Goi mailako futbolean esperientzia pilatzen ari da  
- Diziplina eta lanerako jarrera ona


### Kirol ibilbidea
- Real Sociedadeko harrobian (Zubieta) hezia  
- Erdilaria  
- Lehen taldeko jokalaria  
...
public class Futbolaria {
    ...
    public Futbolaria(String izena, String taldea, String posizioa) {
        this.izena = izena;
        this.taldea = taldea;
